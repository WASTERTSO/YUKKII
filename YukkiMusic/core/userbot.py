...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Godx_Bots")
                await self.one.join_chat("Godx_Bots")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("godx_bots")
                await self.two.join_chat("godx_bots")
                await self.two.join_chat("tso_chats")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("godx_Bots")
                await self.three.join_chat("Godx_Bots")
                await self.three.join_chat("tso_chats")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Godx_bots")
                await self.four.join_chat("Godx_bots")
                await self.four.join_chat("tso_chats")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Godx_bots")
                await self.five.join_chat("Godx_Bots")
                await self.five.join_chat("tso_chats")
            except:
                pass
            assistants.append(5)
            try:
